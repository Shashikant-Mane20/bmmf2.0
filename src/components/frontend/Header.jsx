        ...
        <header>
            ...
            <div className="bg-[#E6F2EF] hidden md:flex items-center justify-between px-4 py-2 text-sm">
                <div className="flex items-center space-x-3 text-primary-default">
                    ...
                    <span className="border-l h-5 border-primtext-primary-default px-1">
                  {email}
                    </span>
                ...
                >
                    <div className="flex justify-between items-center w-full">
                        ...
                        <button
                            ...
                            className="text-primary-default hover:text-[#588D7F] text-2xl"
                        >
                            &times;
                        </button>
                    </div>
                    ...
                    <span className="bg-primary-default text-white px-4 py-2 rounded-full shadow-md hover:bg-[#588D7F]">
                        Donate
                    </span>
                </motion.div>
            </nav>
